...
class SyncController:
    ...
    def read_config(self):
        ...
        if actionstring == 'UPLOAD':
            print('Add upload')
            self.model.add_sync_event(SyncEventType.UPLOAD, datetime.fromisoformat(timestring))
        elif actionstring == 'DOWNLOAD':
            self.model.add_sync_event(SyncEventType.DOWNLOAD, datetime.fromisoformat(timestring))
